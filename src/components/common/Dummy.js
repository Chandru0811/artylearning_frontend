...
import { FaEdit, FaFacebookF, FaInstagram } from "react-icons/fa";

function CMSFooter() {
  // State for managing edit mode and text content
  const [isEditing, setIsEditing] = useState(false);
  const [addressText, setAddressText] = useState("806 Hougang Central, #04-146, Singapore 530806");
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-4 col-12 mt-3">
              ...
              {/* Render input or text based on edit mode */}
              {isEditing ? (
                <div>
                  <input
                    type="text"
                  ...
                  />
                  <button className="btn btn-primary mt-2" onClick={toggleEditMode}>
                    Save
                  </button>
                  <button className="btn btn-secondary mt-2 ms-2" onClick={toggleEditMode}>
                    Cancel
                  </button>
                </div>
              ) : (
                <p>
                  ...
                  &nbsp;
                  <FaEdit style={{ cursor: "pointer" }} onClick={toggleEditMode} />
                </p>
              )}
