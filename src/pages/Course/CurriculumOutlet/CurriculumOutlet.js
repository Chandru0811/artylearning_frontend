...
function CurriculumOutlet() {
    ...
    return (
        <div className="container my-4">
            {storedScreens?.levelCreate && <CurriculumOutletAdd onSuccess={refreshData} />}
                            ...
                            <tr key={index}>
                                ...
                                <td className="d-flex">
                                    {storedScreens?.courseRead && (
                                        <CurriculumOutletView id={data.id} onSuccess={refreshData} />

                                    )}
                                    {storedScreens?.courseUpdate && (
                                        <CurriculumOutletEdit id={data.id} onSuccess={refreshData} />
                                    )}
