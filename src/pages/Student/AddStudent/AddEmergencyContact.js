  ...
  ({ formData, setFormData, handleNext }, ref) => {
    const formik = useFormik({
      initialValues: {
        ...
        studentEmergencyContactPostalCode: formData.studentEmergencyContactPostalCode || "",
        studentEmergencyContactAddress: formData.studentEmergencyContactAddress || "",
      },
                ...
                <div className="container py-3">
                  <div className="row mt-3">
                    ...
                    <div className="col-lg-6 col-md-6 col-12 px-5">
                      <div className="text-start mt-4">
                        <label htmlFor="" className="mb-1 fw-medium">
                          <small>Emergency Contact No</small><span className="text-danger">*</span>
                        </label>
                        <br />
                        <input
                          className="form-control "
