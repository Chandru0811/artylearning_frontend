...
function Leadview() {
  ...
  const generatePDF = () => {
    ...
    doc.text(
      `Date of Assessment : ${doassesmentData.leadDoAssessmentModel[0].assessmentDate.substring(
        0,
        10
      )}`,
      10,
    ...
    doc.text(
      `Referred By : ${doassesmentData.leadDoAssessmentModel[0].referredBy}`,
      120,
      70
    ); // 40 + 30 = 70
    doc.text(
      `Timeslot : ${doassesmentData.leadDoAssessmentModel[0].timeSlotOffered}`,
      120,
      50
    ); // 20 + 30 = 50
